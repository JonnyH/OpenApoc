...
void InitialGameStateExtractor::extractAgentTypes(GameState &state) const
{
	...
	for (unsigned i = 1; i < data_u.agent_types->count(); i++)
	{
		...
		UString id = OpenApoc::format2("{0}{1}", AgentType::getPrefix(), canon_string(a->name));
		...
		switch (i)
		{
			...
			case UNIT_TYPE_BRAINSUCKER:
				a->animation_packs.emplace_back(
				    &state, OpenApoc::format2("{0}bsk", BattleUnitAnimationPack::getPrefix()));
			...
			case UNIT_TYPE_HYPERWORM:
				a->animation_packs.emplace_back(
				    &state, OpenApoc::format2("{0}hypr", BattleUnitAnimationPack::getPrefix()));
			...
			case UNIT_TYPE_SPITTER:
				a->animation_packs.emplace_back(
				    &state, OpenApoc::format2("{0}spitr", BattleUnitAnimationPack::getPrefix()));
			...
			case UNIT_TYPE_POPPER:
				a->animation_packs.emplace_back(
				    &state, OpenApoc::format2("{0}popper", BattleUnitAnimationPack::getPrefix()));
				bodyTypeName = "POPPER";
				infiltrationID = 8;
				a->growthChance = 2;
				a->detectionWeight = 2;
			...
			case UNIT_TYPE_MICRONOID:
				a->animation_packs.emplace_back(
				    &state, OpenApoc::format2("{0}micro", BattleUnitAnimationPack::getPrefix()));
		...
		switch (i)
		{
			...
			case UNIT_TYPE_CORPORATE_BOSS:
				...
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rm1")};
				break;
			case UNIT_TYPE_CULT_LEADER:
			...
			case UNIT_TYPE_ANDROID:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robot")};
				a->image_packs[0][BodyPart::Helmet] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robo1")};
				a->image_packs.push_back(std::map<BodyPart, StateRef<BattleUnitImagePack>>());
				a->image_packs[1][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robot")};
				a->image_packs[1][BodyPart::Helmet] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robo2")};
				a->image_packs.push_back(std::map<BodyPart, StateRef<BattleUnitImagePack>>());
				a->image_packs[2][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robot")};
				a->image_packs[2][BodyPart::Helmet] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robo3")};
				a->image_packs.push_back(std::map<BodyPart, StateRef<BattleUnitImagePack>>());
				a->image_packs[3][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robot")};
				a->image_packs[3][BodyPart::Helmet] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "robo4")};
				break;
			case UNIT_TYPE_GREY:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "grey")};
				break;
			case UNIT_TYPE_UPPER_CLASS_FEMALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rw1")};
				break;
			case UNIT_TYPE_UPPER_CLASS_FEMALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rw2")};
				break;
			case UNIT_TYPE_UPPER_CLASS_FEMALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rw3")};
				break;
			case UNIT_TYPE_UPPER_CLASS_MALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rm1")};
			...
			case UNIT_TYPE_UPPER_CLASS_MALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rm2")};
				break;
			case UNIT_TYPE_UPPER_CLASS_MALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "rm3")};
				break;
			case UNIT_TYPE_CIVILIAN_FEMALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nw1")};
				break;
			case UNIT_TYPE_CIVILIAN_FEMALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nw2")};
				break;
			case UNIT_TYPE_CIVILIAN_FEMALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nw3")};
				break;
			case UNIT_TYPE_CIVILIAN_MALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nm1")};
				break;
			case UNIT_TYPE_CIVILIAN_MALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nm2")};
				break;
			case UNIT_TYPE_CIVILIAN_MALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "nm3")};
				break;
			case UNIT_TYPE_LOWER_CLASS_MALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sm1")};
				break;
			case UNIT_TYPE_LOWER_CLASS_MALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sm2")};
				break;
			case UNIT_TYPE_LOWER_CLASS_MALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sm3")};
				break;
			case UNIT_TYPE_LOWER_CLASS_FEMALE_1:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sw1")};
				break;
			case UNIT_TYPE_LOWER_CLASS_FEMALE_2:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sw2")};
				break;
			case UNIT_TYPE_LOWER_CLASS_FEMALE_3:
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "sw3")};
				break;
			case UNIT_TYPE_MULTIWORM_EGG:
			...
			case UNIT_TYPE_BRAINSUCKER:
				...
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "bsk")};
				break;
			case UNIT_TYPE_MULTIWORM:
				a->inventoryBackground = fw().data->loadImage("xcom3/tacdata/equippic/mworm.pcx");
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "multi")};
				break;
			case UNIT_TYPE_HYPERWORM:
				a->inventoryBackground = fw().data->loadImage("xcom3/tacdata/equippic/hyperwm.pcx");
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "hypr")};
				break;
			case UNIT_TYPE_CHRYSALIS:
				a->inventoryBackground =
			...
			case UNIT_TYPE_SPITTER:
				...
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "spitr")};
				break;
			case UNIT_TYPE_POPPER:
			...
			case UNIT_TYPE_PSIMORPH:
				...
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "psi")};
				break;
			case UNIT_TYPE_QUEENSPAWN:
			...
			case UNIT_TYPE_MICRONOID:
				...
				a->image_packs[0][BodyPart::Body] = {
				    &state, OpenApoc::format2("{0}{1}", BattleUnitImagePack::getPrefix(), "micro")};
				break;
		}
			...
			default:
				...
				for (int i = 1; i <= 3; i++)
				{
					a->damageSfx[AgentType::Gender::Male].push_back(fw().data->loadSample(
					    OpenApoc::format2("RAWSOUND:xcom3/rawsound/extra/hpainm{0}.raw:22050", i)));
					a->fatalWoundSfx[AgentType::Gender::Male].push_back(fw().data->loadSample(
					    OpenApoc::format2("RAWSOUND:xcom3/rawsound/extra/hdethm{0}.raw:22050", i)));
					a->dieSfx[AgentType::Gender::Male].push_back(fw().data->loadSample(
					    OpenApoc::format2("RAWSOUND:xcom3/rawsound/extra/hdethm{0}.raw:22050", i)));
				}
				for (int i = 1; i <= 2; i++)
				{
					a->damageSfx[AgentType::Gender::Female].push_back(fw().data->loadSample(
					    OpenApoc::format2("RAWSOUND:xcom3/rawsound/extra/hpainf{0}.raw:22050", i)));
					a->fatalWoundSfx[AgentType::Gender::Female].push_back(fw().data->loadSample(
					    OpenApoc::format2("RAWSOUND:xcom3/rawsound/extra/hdethf{0}.raw:22050", i)));
		...
		switch (i)
		{
			...
			case UNIT_TYPE_MICRONOID:
			{
				...
				liveItem->name = OpenApoc::format2("Live {0}", a->name);
...
void InitialGameStateExtractor::extractAgentBodyTypes(GameState &state) const
{
	...
	for (int i = 0; i <= 46; i++)
	{
		...
		UString id = OpenApoc::format2("{0}{1}", AgentBodyType::getPrefix(), canon_string(name));
