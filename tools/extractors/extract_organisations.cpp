...
void InitialGameStateExtractor::extractOrganisations(GameState &state) const
{
	...
	for (unsigned i = 0; i < data.organisation_data->count(); i++)
	{
		...
		auto ped = canon_string(data.organisation_names->get(i));
		...
		/*if (i == ORG_CIVILIAN)
		{
		    o->hirableAgentTypes[{&state, "X-COM_QUANTUM_PHYSICIST"}] = {0,2};
		    o->hirableAgentTypes[{&state, "X-COM_BIOCHEMIST"}] = { 0,2 };
		    o->hirableAgentTypes[{&state, "X-COM_MECHANIC"}] = { 0,1 };
		}*/
		...
		if (i != ORG_CIVILIAN && i != ORG_XCOM && i != ORG_ALIENS)
		{
			...
			o->vehiclePark[{&state, "CONSTRUCTION_VEHICLE"}] = 3;
			o->vehiclePark[{&state, "RESCUE_TRANSPORT"}] = 3;
			o->vehiclePark[{&state, "CIVILIAN_CAR"}] = 3;
			o->vehiclePark[{&state, "BLAZER_TURBO_BIKE"}] = 3;
			...
			switch (vdata.vehiclePark)
			{
				...
				case 2:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 2;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 1;
					break;
				// Transtellar
				case 3:
					...
					o->vehiclePark[{&state, "AIRTAXI"}] = 10;
					o->vehiclePark[{&state, "AIRTRANS"}] = 10;
					o->vehiclePark[{&state, "AUTOTAXI"}] = 10;
					o->vehiclePark[{&state, "AUTOTRANS"}] = 10;
					o->vehiclePark[{&state, "SPACE_LINER"}] = 6;
					// Combat vehicles
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 2;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 1;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 1;
					break;
				...
				case 4:
					...
					o->vehiclePark[{&state, "HOVERBIKE"}] = 1;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 1;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 1;
					break;
				// Technocrats Extopians Solmine Lifetree
				case 5:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 3;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 2;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 1;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 1;
					break;
				// Cyberweb
				case 6:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 3;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 2;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 2;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 1;
					break;
				// MSec
				case 10:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 4;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 2;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 3;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 3;
					break;
				// SELF / Mutant Alliance
				case 20:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 8;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 4;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 5;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 5;
					break;
				// Sirius
				case 30:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 11;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 5;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 8;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 7;
					break;
				// Megapol
				case 55:
					if (i != ORG_MEGAPOL)
					...
					o->vehiclePark[{&state, "POLICE_HOVERCAR"}] = 18;
					o->vehiclePark[{&state, "POLICE_CAR"}] = 15;
					o->vehiclePark[{&state, "GRIFFON_AFV"}] = 9;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 9;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 9;
					break;
				// Gangs
				case 60:
					o->vehiclePark[{&state, "PHOENIX_HOVERCAR"}] = 24;
					o->vehiclePark[{&state, "HOVERBIKE"}] = 12;
					o->vehiclePark[{&state, "VALKYRIE_INTERCEPTOR"}] = 15;
					o->vehiclePark[{&state, "HAWK_AIR_WARRIOR"}] = 15;
					break;
				default:
			...
			auto &missions = o->recurring_missions[{&state, "HUMAN"}];
			// Agents
	...
	state.player = {&state, "X-COM"};
	state.aliens = {&state, "ALIEN"};
	state.civilian = {&state, "CIVILIAN"};
