...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell",
    ...
    sudo apt-get install cmake ninja-build libsdl2-dev cmake build-essential git libunwind8-dev libboost-locale-dev libboost-program-options-dev qtbase5-dev libvorbis-dev -y
	...
	cd OpenApoc-build
	cmake -DCMAKE_BUILD_TYPE=RelWithDebInfo -GNinja /vagrant
	cmake --build .
    )
