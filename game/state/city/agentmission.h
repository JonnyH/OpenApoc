...
class AgentMission
{
  ...
  public:
	...
	static AgentMission awaitPickup(GameState &state, Agent &a, const StateRef<Building> &target);
	...
	static AgentMission teleport(GameState &state, Agent &a, const StateRef<Building> &b);
	static AgentMission investigateBuilding(GameState &state, Agent &a,
