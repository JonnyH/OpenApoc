...
void AgentSheet::display(const Agent &item, std::vector<sp<Image>> &ranks, bool turnBased)
{
	...
	form->findControlTyped<Label>("LABEL_1")->setText(tr("Health").value);
	...
	form->findControlTyped<Label>("LABEL_2")->setText(tr("Accuracy").value);
	...
	form->findControlTyped<Label>("LABEL_3")->setText(tr("Reactions").value);
	...
	form->findControlTyped<Label>("LABEL_4")->setText(turnBased ? tr("Time Units").value
	                                                            : tr("Speed").value);
	...
	form->findControlTyped<Label>("LABEL_5")->setText(tr("Stamina").value);
	...
	form->findControlTyped<Label>("LABEL_6")->setText(tr("Bravery").value);
	...
	form->findControlTyped<Label>("LABEL_7")->setText(tr("Strength").value);
	...
	form->findControlTyped<Label>("LABEL_8")->setText(tr("Psi-energy").value);
	...
	form->findControlTyped<Label>("LABEL_9")->setText(tr("Psi-attack").value);
	...
	form->findControlTyped<Label>("LABEL_10")->setText(tr("Psi-defence").value);
