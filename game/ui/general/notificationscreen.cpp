...
NotificationScreen::NotificationScreen(GameState &state, CityView &cityView, const UString &message,
...
NotificationScreen::NotificationScreen(GameState &state, BattleView &battleView,
