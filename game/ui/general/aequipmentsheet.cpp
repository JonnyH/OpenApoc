                                            ...
                                            bool researched)
{
	...
	form->findControlTyped<Label>("LABEL_1_R")
	    ->setText(OpenApoc::format2("{0}", item ? item->getWeight() : itemType.weight));
                                     ...
                                     const AEquipmentType &itemType)
{
	...
	form->findControlTyped<Label>("LABEL_3_R")->setText(OpenApoc::format2("{0}", itemType.damage));
}
...
void AEquipmentSheet::displayAmmo(sp<AEquipment> item, const AEquipmentType &itemType)
{
	...
	form->findControlTyped<Label>("LABEL_8_R")->setText(OpenApoc::format2("{0}", itemType.damage));

	form->findControlTyped<Label>("LABEL_9_L")->setText(tr("Rounds"));
	form->findControlTyped<Label>("LABEL_9_R")
	    ->setText(item ? OpenApoc::format2("{0} / {1}", item->ammo, itemType.max_ammo)
	                   : OpenApoc::format2("{0}", itemType.max_ammo));
...
void AEquipmentSheet::displayArmor(sp<AEquipment> item, const AEquipmentType &itemType)
{
	...
	form->findControlTyped<Label>("LABEL_2_R")
	    ->setText(item ? OpenApoc::format2("{0} / {1}", item->armor, itemType.armor)
	                   : OpenApoc::format2("{0}", itemType.armor));
}
